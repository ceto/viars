...
function setup() {
  ...
  load_theme_textdomain('viars', get_template_directory() . '/lang');
 ...
 // Enable post thumbnails
  ...
  add_image_size( 'medium43', get_option( 'medium_size_w' ), get_option( 'medium_size_w' ) * 0.75, true );
